        ...
        <div class="flex flex-col mt-14 w-6/12 mx-auto">
            ...
            <div class="flex flex-col space-y-3 mt-4">
                ...
                <div class="pagination flex justify-center gap-5 items-center">
                    <BtnPagination @handle-click="prevItem" button-name="<" button-type="button" :disabled="page ===1"/>
                    <span class="text-xl text-gray-200">{{ page }} of {{ totalPages }}</span>
                    <BtnPagination @handle-click="nextItem" button-name=">" button-type="button" :disabled="page === totalPages"/>
                </div>
            </div>
        </div>
